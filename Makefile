...
COREFILES = main.c hooks.c free.c free_textures.c init.c init_mlx_struct.c init_pre_render.c pre_render.c map_utils.c exit_err.c load_textures.c
...
RENDERFILES = render_next_frame.c show_map2d.c update.c update_utils.c collisions.c render_whole_frame.c
